...
En desarrollo, Vite proxy reenvia `/api/v1` al backend real. En Vercel, si falta `VITE_API_BASE_URL`, la app usa `http://37.60.226.53:8000/api/v1` como fallback para evitar 404 en rutas como `/alerts`.
